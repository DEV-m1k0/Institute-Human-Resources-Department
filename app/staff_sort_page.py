...
"""
    ...
    def __fill(self, *args):
        ...
        columns = ('ID', 'Имя', 'Фамилия', 'Отчество', 'Роль', 'Дата рождения')           
        ...
        queue = f"""
                       SELECT employees.id, employees.name, employees.second_name, employees.surname, employees.role, employees.date_birth
                       FROM employees
